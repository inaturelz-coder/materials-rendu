...
### Ch0 绪论
材料科学四面体 + 一静一动方法论 + 四条线 + 怎么读这本书（无配套代码）
...
| 附录 | 主题 |
|---|---|
| A | 计算材料学工具速览（DFT/MD/MLIP、CALPHAD/相场、FEM 软件与入门路径）|
| B | 术语表与索引（中英对照，按一静一动分组）|
| C | 材料表征手段速览（衍射/成像/谱学/取向/原子级 + 分辨率-视场定位图）|
...
### 阅读
- **完整阅读**：`book/打通材料基础任督二脉_v1.1.pdf`（139 页）
